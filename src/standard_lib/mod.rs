...
pub fn call(
    ...
    match name {
        ...
        "sys.printf" => sys::printf(args, named_args),
        ...
        "sys.read_all" => sys::read_all(args, named_args),
        "sys.chroot" => sys::chroot(args, named_args),
        "sys.nice" => sys::nice(args, named_args),
        "sys.sync" => sys::sync(args, named_args),
        "sys.stdin_isatty" => sys::stdin_isatty(args, named_args),
        "sys.stdout_isatty" => sys::stdout_isatty(args, named_args),
        ...
        "os.environ" => os::environ(args, named_args),
        "os.groups" => os::groups(args, named_args),
        "os.hostid" => os::hostid(args, named_args),
        "os.nproc" => os::nproc(args, named_args),
        "os.df" => os::df(args, named_args),
        "os.argv" => os::argv(args, named_args, state),
        "os.getcwd" => os::getcwd(args, named_args),
        "os.username" => os::username(args, named_args),
        "os.ttyname" => os::ttyname(args, named_args),
        "os.uptime" => os::uptime(args, named_args),
        "os.temp_dir" => os::temp_dir(args, named_args),
        "os.load_average" => os::load_average(args, named_args),
        "os.users" => os::users(args, named_args),
        "os.user_count" => os::user_count(args, named_args),
        "os.user_id" => os::user_id(args, named_args),
        "os.group_id" => os::group_id(args, named_args),
        "os.tty_get_mode" => os::tty_get_mode(args, named_args),
        "os.tty_set_mode" => os::tty_set_mode(args, named_args),
        ...
        "math.min" => math::min(args, named_args),
        "math.floor" => math::floor(args, named_args),
        "math.round" => math::round(args, named_args),
        "math.ceil" => math::ceil(args, named_args),
        "math.random" => math::random(args, named_args),
        "math.human_bytes" => math::human_bytes(args, named_args),
        "math.parse_size" => math::parse_size(args, named_args),
        "math.range" => math::range(args, named_args),

        "fs.read" => fs::read(args, named_args),
        "fs.write" => fs::write(args, named_args),
        "fs.append" => fs::append(args, named_args),
        "fs.link" => fs::link(args, named_args),
        "fs.symlink" => fs::symlink(args, named_args),
        "fs.delete" => fs::delete(args, named_args),
        "fs.exists" => fs::exists(args, named_args),
        "fs.mkdir" => fs::mkdir(args, named_args),
        "fs.mkfifo" => fs::mkfifo(args, named_args),
        "fs.mknod" => fs::mknod(args, named_args),
        ...
        "fs.mktemp" => fs::mktemp(args, named_args),
        "fs.read_hex" => fs::read_hex(args, named_args),
        "fs.write_hex" => fs::write_hex(args, named_args),
        "fs.read_dir_meta" => fs::read_dir_meta(args, named_args),
        "fs.read_meta" => fs::read_meta(args, named_args),
        "fs.path_filename" => fs::path_filename(args, named_args),
        "fs.path_parent" => fs::path_parent(args, named_args),
        "fs.path_join" => fs::path_join(args, named_args),
